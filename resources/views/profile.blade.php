    ...
    <div class="row">
        <div class="col-md-6">
          <div class="tile">   
                <h6>Update Name</h6>            
            <div class="tile-body">
              <form id="form" method="POST" autocomplete="off" action="{{ route('update_name') }}">
                @csrf
                 <div class="row">
                  <div class="col-md-12">
        ...
        <div class="col-md-6">
            <div class="tile">   
                <h6>Update Email</h6>            
                <div class="tile-body">
                <form id="form" method="POST" autocomplete="off" action="{{ route('update_email') }}">
                    @csrf
                    <div class="row">
                        <div class="col-md-12">
                        <div class="form-group">
      ...
      <div class="row">
        <div class="col-md-6">
            ...
            <div class="tile-body">
                <form id="form" method="POST" autocomplete="off" action="{{ route('update_password') }}">
                @csrf
