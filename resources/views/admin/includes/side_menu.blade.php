<!-- Sidebar menu-->
  ...
  <aside class="app-sidebar">
    ...
    <ul class="app-menu">
      ...
      <li><a class="app-menu__item {{ Route::currentRouteNamed('units.index') ? 'active' : '' || Route::currentRouteNamed('units.create') ? 'active' : ''}}" href="{{ route('units.index') }}"><i class="app-menu__icon 	fa fa-clipboard"></i><span class="app-menu__label">Units</span></a></li>  
